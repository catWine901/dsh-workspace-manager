 ...
 */
import { z } from 'zod';
import { mountWrapperChildren, wrapperChildrenOf } from "./adapter.js";
import { WORKBENCH_RUNTIME_SERVICE } from "./workbench-runtime.js";
...
export async function apply(ctx, config) {
    ...
    ctx.effect(() => () => { disposeSurface(); }, 'page-app-manager.wrapper: unregister the feature surface seat with the wrapper fiber');
}
