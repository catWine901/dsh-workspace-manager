 ...
 */
export declare function managedRootHash(row: EntryOptions): string;
/**
 ...
 */
export declare function composePatchRows(patches: PatchOptions[] | undefined, warn?: (message: string) => void): EntryOptions[];
/**
 ...
 */
export declare function parseEntryList(content: string): unknown;
/**
 ...
 */
export declare function findLoaderRow(loader: LoaderLike, rootEntryId: string): LoaderRow | undefined;
/**
 ...
 */
export declare function fiberStateOf(loaderRow: LoaderRow | undefined): number | undefined;
/**
 ...
 */
export declare function isActiveFiberState(state: number | undefined): boolean;
/**
 ...
 */
export declare function fiberStateLabelOf(state: number | undefined): PageAppRuntimeStateLabel | undefined;
/**
 ...
 */
export declare function wrapperChildrenOf(ctx: Context): EntryOptions[] | undefined;
/**
 ...
 */
export declare function mountWrapperChildren(ctx: Context, children: readonly EntryOptions[]): Promise<() => Promise<void>>;
