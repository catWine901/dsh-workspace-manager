...
import { parsePageAppRegistry, readPageAppJournal, removePageAppJournal, resolvePageAppProfilePaths, withPageAppProfileLock, } from '@deepseek-ai/dsh-page-app-profile';
import { derivePageAppExpectedRoots } from "./transaction.js";
 ...
 */
export async function recoverPageAppTransaction(profileDir, executor, runtime) {
...
export const RECOVERY_OWNED_FILES = OWNED_RELATIVE_FILES;
