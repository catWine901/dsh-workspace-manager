import { C as readPageAppRegistry, D as parsePageAppSourceDisplay, E as parsePageAppManifest, O as resolvePageAppProfilePaths, S as parsePageAppRegistry, T as assertPageAppSourceNoCredentials, _ as readPageAppJournal, b as writePageAppJournal, c as managerWrapperResolvable, g as parsePageAppJournal, h as advancePageAppJournalPhase, m as withPageAppProfileLock, o as managedRootWrapperId, p as loadOverlayPatches, r as WORKBENCH_RUNTIME_SERVICE$1, s as managedRootWrapperRow, t as PROFILE_RUNTIME_SERVICE, v as removePageAppJournal, w as writePageAppRegistry, x as renderPageAppRuntimeLayer, y as snapshotPageAppJournalFiles } from "./profile-runtime-bridge-BcnK0ROA.js";
import { a as fiberStateOf, c as managedRootHash, i as fiberStateLabelOf, n as createWorkbenchRuntime, o as findLoaderRow, r as composePatchRows, s as isActiveFiberState, t as WORKBENCH_RUNTIME_SERVICE, u as parseEntryList } from "./workbench-runtime-B031ig8S.js";
...
function createPnpmExecutor(spawn) {
	const exec = spawn ?? (async (file, args, options) => {
		const { execa } = await import("./execa-Wn48dT8z.js");
